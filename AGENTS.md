...
- Do not write SSH aliases, hostnames, absolute server paths, or other private machine details into tracked files. Put any needed local run notes under `.private/`, `private/`, `local_runs/`, `remote_runs/`, or `reports/private/`, which are ignored.
